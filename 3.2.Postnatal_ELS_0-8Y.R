...
# 1. CREATE POSTNATAL CUMULATIVE ELS RISK SCORE 

# This section subsets all postnatal stress variables (LE/CR/PR/IR/DV) into 'postnatal_stress'
postnatal_stress <- data.frame(alspac.table[,c('cidB2957', # pregnancy ID
                                       'qlet',
                                       ...
                                       'p_interpersonal_sensitivity', # PR
                                       'divorce_8wk',
                                       'divorce_8m',
                                       'divorce_21m',
                                       'divorce_3y',
